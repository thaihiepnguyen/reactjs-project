  ...
  return (
    <div className={classes.classItem} onClick={() => router.push(routes.courseDetail + id)}>
      <div className={classes.className}>
        <img
          className={classes.classAvt}
          aria-hidden="true"
          src={teacherAvatar || "https://lh3.googleusercontent.com/a/default-user=s75-c"}
        ...
        <div className={classes.titleContainer}>
          ...
          <div className={classes.classTitle}>
            <Link href={routes.myCourses} className={classes.classTitleText}>
              {title}
            </Link>
          </div>
          ...
          <div>
            <Link href={routes.myCourses} className={classes.classTeacherText}>
              {teacherName}
            </Link>
          </div>
        </div>
